...
TRANSLATIONS = {
    ...
    "STRINGID_PKMNPOISONEDBY": "{B_EFF_NAME_WITH_PREFIX} отравлен из-за {B_SCR_NAME_WITH_PREFIX2}: {B_BUFF1}!",
    ...
    "STRINGID_PKMNENERGYDRAINED": "{B_SCR_NAME_WITH_PREFIX} теряет энергию!",
    ...
    "STRINGID_PKMNWASDEFROSTEDBY": "{B_SCR_NAME_WITH_PREFIX}: {B_CURRENT_MOVE} растапливает лёд!",
