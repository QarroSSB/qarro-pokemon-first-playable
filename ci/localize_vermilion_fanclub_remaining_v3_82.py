...
REPLACEMENTS = {
    "VermilionCity_PokemonFanClub_Text_AdmirePikachusTail": (("Won't you admire my PIKACHU's", "adorable tail?"), '''VermilionCity_PokemonFanClub_Text_AdmirePikachusTail::
\t.string "Полюбуйся очаровательным хвостом\\n"
\t.string "моего PIKACHU!$"
'''),
    "VermilionCity_PokemonFanClub_Text_PikachuTwiceAsCute": (("Humph!", "My PIKACHU is twice as cute"), '''VermilionCity_PokemonFanClub_Text_PikachuTwiceAsCute::
\t.string "Хм!\\p"
\t.string "Мой PIKACHU вдвое милее\\n"
\t.string "того!$"
'''),
    "VermilionCity_PokemonFanClub_Text_AdoreMySeel": (("I just adore my SEEL!", "It squeals, “Kyuuuh,”"), '''VermilionCity_PokemonFanClub_Text_AdoreMySeel::
\t.string "Я просто обожаю моего SEEL!\\n"
\t.string "Он такой милый!\\p"
\t.string "Когда я его обнимаю, он пищит:\\n"
\t.string "“Кьююю!”$"
'''),
    "VermilionCity_PokemonFanClub_Text_SeelFarMoreAttractive": (("Oh, dear!", "My SEEL is far more attractive."), '''VermilionCity_PokemonFanClub_Text_SeelFarMoreAttractive::
\t.string "Ох, ну что ты!\\p"
\t.string "Мой SEEL куда привлекательнее.\\n"
\t.string "Я бы сказала, раза в два.$"
'''),
    "VermilionCity_PokemonFanClub_Text_Pikachu": (("PIKACHU: Chu! Pikachu!",), '''VermilionCity_PokemonFanClub_Text_Pikachu::
\t.string "PIKACHU: Чу! Пикачу!$"
'''),
    "VermilionCity_PokemonFanClub_Text_Seel": (("SEEL: Kyuoo!",), '''VermilionCity_PokemonFanClub_Text_Seel::
\t.string "SEEL: Кьюу!$"
'''),
    "VermilionCity_PokemonFanClub_Text_ChairmanVeryVocalAboutPokemon": (("Our CHAIRMAN is very vocal about", "POKéMON."), '''VermilionCity_PokemonFanClub_Text_ChairmanVeryVocalAboutPokemon::
\t.string "Наш ПРЕДСЕДАТЕЛЬ обожает говорить\\n"
\t.string "о ПОКЕМОНАХ.$"
'''),
    "VermilionCity_PokemonFanClub_Text_ListenPolitelyToOtherTrainers": (("Let's all listen politely to other", "TRAINERS!"), '''VermilionCity_PokemonFanClub_Text_ListenPolitelyToOtherTrainers::
\t.string "Давайте вежливо слушать других\\n"
\t.string "ТРЕНЕРОВ!$"
'''),
    "VermilionCity_PokemonFanClub_Text_SomeoneBragsBragBack": (("If someone brags, brag right back!",), '''VermilionCity_PokemonFanClub_Text_SomeoneBragsBragBack::
\t.string "Если кто-то хвастается —\\n"
\t.string "похвастайся в ответ!$"
'''),
    "VermilionCity_PokemonFanClub_Text_ChairmanReallyAdoresHisMons": (("Our CHAIRMAN really does adore his", "POKéMON is DAISY, I think."), '''VermilionCity_PokemonFanClub_Text_ChairmanReallyAdoresHisMons::
...
def main() -> int:
    ...
    out.write_text(json.dumps({"marker": MARKER, "file": str(REL), "translatedBlocks": list(REPLACEMENTS), "translatedBlockCount": len(REPLACEMENTS), "scope": "remaining pinned-upstream Vermilion Pokemon Fan Club runtime text only", "policy": "FireRed / Expansion 1.17.0 / Gen I-V; Pokemon+Move+Ability proper names remain English", "ashBondTouched": False, "ashCapTouched": False}, ensure_ascii=False, indent=2) + "\n", encoding="utf-8")
    print(f"[{MARKER}] PASS: translated {len(REPLACEMENTS)} remaining Fan Club blocks; Ash Bond/Ash Cap untouched")
    next_script = Path(__file__).with_name("localize_ssanne_kitchen_v3_83.py")
