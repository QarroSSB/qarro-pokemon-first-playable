#!/usr/bin/env python3
"""Qarro v3.228: polish Fame Checker origin object names for Daisy.

Targets only Daisy's six single-string origin-object labels verified
...
MARKER = "QARRO_RU_FAME_CHECKER_OBJECTS_DAISY_QUALITY_V3_227"
TARGET = Path("data/text/fame_checker_frlg.inc")
TRANSLATIONS = {
    "gFameCheckerFlavorTextOriginObjectName_Daisy0": "ПОМОЩНИК$",
    "gFameCheckerFlavorTextOriginObjectName_Daisy1": "ЖЕНЩИНА$",
    "gFameCheckerFlavorTextOriginObjectName_Daisy2": "МУЖЧИНА$",
    "gFameCheckerFlavorTextOriginObjectName_Daisy3": "ЖУРНАЛ ПОКЕМОНОВ$",
    "gFameCheckerFlavorTextOriginObjectName_Daisy4": "СТАРУШКА$",
    "gFameCheckerFlavorTextOriginObjectName_Daisy5": "ЖУРНАЛ ПОКЕМОНОВ$",
}
BANNED_UNICODE = set("—–←→“”«»…")
...
def main() -> int:
    ...
    if len(TRANSLATIONS) != 6:
        raise RuntimeError("unexpected v3.228 Fame Checker object-name set")
    ...
    out = root / "build" / "qarro_ru_fame_checker_objects_daisy_quality_v3_228_audit.json"
