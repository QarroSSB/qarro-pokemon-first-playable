...
FILES = {
    "data/maps/Route4_PokemonCenter_1F_Frlg/scripts.inc": {
        ...
        "Route4_PokemonCenter_1F_Text_PaidOutrageouslyForMagikarp": "{PLAYER} платит целых ¥500\\nза MAGIKARP...$",
        ...
        "Route4_PokemonCenter_1F_Text_IDontGiveRefunds": "МУЖЧИНА: Деньги не верну.\\nСделка есть сделка!$",
    ...
    "data/maps/CeladonCity_DepartmentStore_3F_Frlg/scripts.inc": {
        ...
        "Text_CounterDeclined": "Неинтересно? Приходи,\\nесли передумаешь.$",
