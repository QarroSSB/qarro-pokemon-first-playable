#!/usr/bin/env python3
"""Qarro v3.167: localize the next safe Pokémon Storage runtime-message subset.
...
TRANSLATIONS = {
    "MSG_HOLDING_POKE": ("You're holding a POKéMON!", "Ты держишь ПОКЕМОНА!"),
    ...
    "MSG_GIVE_TO_MON": ("GIVE to a POKéMON?", "ДАТЬ ПОКЕМОНУ?"),
